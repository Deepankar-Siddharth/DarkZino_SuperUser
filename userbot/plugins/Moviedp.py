...
COLLECTION_STRING = [
  ...
  "iron-man-screensavers-and-wallpaper",

  "avengers-hd-wallpapers-1080p",
  
  "agents-of-shield-wallpaper",

  "superman-shield-wallpaper",
  
  "avengers-wallpaper-for-desktop",

  "star-wars-star-destroyer-wallpaper",

  "amazing-spiderman-phone-wallpaper",

  "wolverine-wallpaper-full-hd",
...
@borg.on(admin_cmd(pattern="moviesdp ?(.*)"))
